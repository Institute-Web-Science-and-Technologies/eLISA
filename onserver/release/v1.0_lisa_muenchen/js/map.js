...
function map_init() {
	...
	// hard coded map extend of munich (11.36 E, 48.06 N, 11.73 E, 48.25 N)
	// tranformed to OpenLayers.Projection("EPSG:4326")
	...
	polyLayer = new OpenLayers.Layer.GML("Bezirke",
		"Geodaten/OSM_Muenchen_bezirke.kml", { format: OpenLayers.Format.KML,
