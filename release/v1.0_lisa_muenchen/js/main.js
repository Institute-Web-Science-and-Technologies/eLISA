...
function handleUpdate(features, features_labels, features_selection, features_weight, pois, pois_labels, pois_selection, pois_weight){
	...
	var tableOfFeature;  // tablee aus des feature i entnommen wird
	var indexOfFeature;  //index fuer jedes feature
	
	var tableOfFeature = new Array();
	var indexOfFeature = new Array();
	  // feature: age   
	tableOfFeature[0] = Bezirke2010agenorm;
	indexOfFeature[0] = 3;
	// tableOfFeature[0] = Bezirke2009singlehhnorm;
	// indexOfFeature[0] = 4;
	  // feature: cars
	tableOfFeature[1] = Bezirke2010tabnorm;
	indexOfFeature[1] = 11;
	  // feature singles
	tableOfFeature[2] = Bezirke2009paarehhnorm;
	indexOfFeature[2] = 3;
	  // feature couples
	tableOfFeature[3] = Bezirke2009paarehhnorm;
	indexOfFeature[3] = 5;
	...
	for (var district=1; district < 26; district++) {
...
//console.log("	Age selected, weight: " + featureValue + " featureValue: " + featureWeight + " opacity" + regionOpacity);	
		...
		feature_status[district] = regionOpacity;	
	}
