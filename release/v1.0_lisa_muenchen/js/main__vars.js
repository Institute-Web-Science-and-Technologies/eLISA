...
var pois_selection = [true,true,false,false,true,false,false,true];
...
poi_setup = {
	...
	'supermarkets' :   { radius: 800, intensity: 0.5, file: 'poi/supermarket.osm' },
	...
	'hardwarestores' : { radius: 800, intensity: 0.5, file: 'poi/doityourself.osm' },
}
